...
//Acceso a la base de datos
            ...
            String sql = "SELECT * FROM talumnosnotas ORDER BY codigoalumnonota DESC";
...
//Se canjearán por datos que se extraen con rs.getString(1) siendo el valor del campo Codigo
                map.put("notaalumno", rs.getString(1));
                map.put("codigoenlacealumnonota", rs.getString(2));
...
//del map es decir de la estructura de datos y el conjunto de datos obtenidos a visualizar.
            JasperPrint print
                    = JasperFillManager.fillReport(ImprimirNotas.class.getResourceAsStream("informe/Notas.jasper"),
                            map, fuenteDeDatos);
